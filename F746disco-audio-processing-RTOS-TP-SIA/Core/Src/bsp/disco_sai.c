...
void setInput(uint16_t InputDevice) {
	...
	if (InputDevice == INPUT_DEVICE_DIGITAL_MICROPHONE_2)
		hsai_BlockB2.SlotInit.SlotActive = CODEC_AUDIOFRAME_MICIN; // dig mic 2
	else if (InputDevice == INPUT_DEVICE_INPUT_LINE_1)
		hsai_BlockB2.SlotInit.SlotActive = CODEC_AUDIOFRAME_LINEIN; // line in
...
// other callbacks are in audio.c TODO : move here
